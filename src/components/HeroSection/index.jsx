  ...
  return (
    ...
    >
        ...
        >
          ...
          {/* Gold Rate Display */}
          {goldRate && (
            <div className="absolute top-4 right-4 bg-black/70 backdrop-blur-sm text-white px-4 py-2 rounded-lg flex items-center z-20">
              <span className="text-sm font-medium mr-2">24K Gold:</span>
